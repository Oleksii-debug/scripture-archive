...
class CompositeAccessibilityTests(unittest.TestCase):
    ...
    def test_nested_drag_only_child_fails_and_linear_report_matches(self) -> None:
        ...
        match = [
            ...
            if item["code"] == "A11Y_EXPLICIT_VISUAL_OR_POINTER_DEPENDENCY"
            and item["path"] == "task.steps[0].drag_only"
        ]
    ...
    def test_nested_media_without_text_equivalent_fails(self) -> None:
            ...
            [
                {
                    ...
                    "task_type": "SHORT_TEXT",
                    "label": "Inspect map",
                    "prompt": "Describe the relevant location.",
                    "accessibility": self._child_accessibility(),
                    "visual": {"media_slot": "map://case-1"},
                }
            ]
        )
        ...
        self.assertFalse(inspection["passed"])
        self.assertIn(
            ("A11Y_MEDIA_TEXT_EQUIVALENT_MISSING", "task.steps[0].visual.media_slot"),
            ...
            [
                {
                    ...
                    "task_type": "SHORT_TEXT",
                    "label": "Explain",
                    "prompt": "State what the cited text says.",
                    "accessibility": self._child_accessibility(),
                }
            ]
        )
            ...
            "steps": [
                {
                    "step_id": "secret-step",
                    "type": "SHORT_TEXT",
                    "required": "grading-only answer truth",
                }
            ]
        }
