...
ALLOWLISTED_COMMANDS = frozenset({
  ...
  "research.list_notes","research.upsert_note","research.delete_note","research.get_chronology_lab","research.get_evidence_graph","research.get_witness_matrix","research.get_dossiers","research.export",
...
def validate_request_shape(request:Any)->tuple[str,str,dict[str,Any]]:
    ...
    if cmd=='research.get_dossiers' and payload:
        raise ValueError('research.get_dossiers accepts an empty payload')
