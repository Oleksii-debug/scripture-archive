...
export class KeymapUI{
 constructor(api,dispatcher,announce){this.api=api;this.dispatcher=dispatcher;this.announce=announce;this.actions=[];this.editing=null;this.keymapReturn=null;this.shortcutReturn=null;this.savingShortcut=false;this.wire()}
 wire(){
 ...
 async refresh(){this.actions=(await this.api('keymap.list')).actions;this.dispatcher.setActions(this.actions)}
